...
@Component({
  selector: 'app-profile-tournament-staff',
  standalone: false,
  templateUrl: './profile-tournament-staff.html',
  styleUrl: './profile-tournament-staff.css'
})
export class ProfileTournamentStaff {
